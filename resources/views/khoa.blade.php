...
<h1 style="text-align: center">Thông tin về Khoa</h1>
  <a href="{{URL::to('/show-khoa')}}" style="color: black">Xem danh sách khoa</a><br>
...
<form action="{{URL::to('/save-khoa')}}" method="POST" >
              ...
              {{csrf_field()}}
          <label for="">Tên Khoa:</label>     <input type="text" name="khoa"><br>
             
          <br>
          <button type="submit" name="">Thêm Khoa</button>
          </form>
</div>
