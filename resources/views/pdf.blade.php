...
<form action="{{URL::to('/search')}}" method="GET">
  ...
  <input name="search" style="color: black;" type="text"> <button style="color: black;" type="submit" >Tìm</button>
  </form>
  ...
  <table class="table">
    ...
    <tr>
        ...
        <td><a href="{{URL::to('show-student',$data['_id'])}}" class="material-icons">delete</a><a class="bi bi-pen"></a>
