...
<form action="{{URL::to('/search')}}" method="GET">
  <input name="search" style="color: black;" type="text" placeholder="Nhập mssv"> <button style="color: black;" type="submit" >Tìm sinh viên</button>
  </form>
  ...
  <table class="table">
    ...
    <tr>
        ...
        <td><a href="{{URL::to('show-student',$data['_id'])}}" class="glyphicon glyphicon-user"></a>
